...
String getDiffTime(DateTime dateTime) {
  ...
  if (min == 0 && hours == 0 && days == 0 && years == 0 && month == 0) {
   ...
   return "  ";
   //'${LanguageProvider.translate('ad', 'ago')} ${getTimeNumber(years, month, days, hours, min, sec)}${getTimeChar(years, month, days, hours, min, sec)}';
}
...
Color hexToColor(String code) {
  ...
  //Color(int.parse('0xFF${Constants.mainColor}'));
}
