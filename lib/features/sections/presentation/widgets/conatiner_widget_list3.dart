...
class ContainerWidgetList3 extends StatelessWidget {
  const ContainerWidgetList3({super.key, required this.index});
  final int index;
  @override
          ...
          child: Stack(
            ...
            children: [
              Positioned(
                child: Column(
                          children: <Widget>[
                 myprovider.departmentModellist3[index].widget,
                 SizedBox(height:0.5.h ,),
                Row(
                  children: <Widget>[
                    Text(
                      "${myprovider.departmentModellist3[index].text1}",
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text(
                      "${myprovider.departmentModellist3[index].text2}",
                    ...
                    Text(
                      ...
                      "${myprovider.departmentModellist3[index].text2}",
                      style: TextStyleClass.normalLineThroughStyle(color: Color(0xffE3BB47),),
                    )
                  ],
                )
                          ],
