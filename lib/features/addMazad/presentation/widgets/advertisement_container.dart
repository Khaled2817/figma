...
Text("اضافة فيديو او صور",style:TextStyleClass.semiBoldStyle(color: Color(0xffB9C0C9)),),
SizedBox(height: 2.h,),
Row(
  crossAxisAlignment: CrossAxisAlignment.start,
  ...
  children: <Widget>[Material(
    color: Colors.white,
      ...
      child: InkWell(
        ...
        child:Column(
          ...
          children: <Widget>[SvgWidget(svg: Images.videoFileFill), Text(
                    "فيديو",
                    style:
    ...
    Material(
      ...
      child: InkWell(
        ...
        child:Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[SvgWidget(svg: Images.imagebox), Text(
                    "صور",
                    style:
                        TextStyleClass.semiBoldStyle(color: Color(0xff194B8C)),
                  ),
